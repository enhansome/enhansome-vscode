...
out [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,057 | 🐛 105 | 📅 2026-08-21. <br/> <br/> <a href="https://awesome.re"><img src="https://awesome.re/badge.svg" alt="Awesome"/></a>
[<img src="https://github.com/viatsko/awesome-vscode/actions/workflows/links.yml/badge.svg" alt="Links Status"/>](https://github.com/viatsko/awesome-vscode/actions/workflows/links.yml) ⭐ 28,993 | 🐛 54 | 🌐 JavaScript | 📅 2026-06-21
...
* [Source code](https://github.com/microsoft/vscode) ⭐ 190,384 | 🐛 20,353 | 🌐 TypeScript | 📅 2026-09-02 on GitHub
* [Monthly iteration plans](https://github.com/Microsoft/vscode/issues?utf8=%E2%9C%93\&q=label%3Aiteration-plan+) ⭐ 190,384 | 🐛 20,353 | 🌐 TypeScript | 📅 2026-09-02
...
Make sure to visit it at [Microsoft/vscode-recipes](https://github.com/Microsoft/vscode-recipes) ⭐ 5,965 | 🐛 40 | 🌐 JavaScript | 📅 2026-03-30
...
See the difference between these two [here](https://github.com/michaelgmcd/vscode-language-babel/issues/1) ⭐ 133 | 🐛 27 | 🌐 JavaScript | 📅 2023-09-25

### Linters

* [AVA](https://marketplace.visualstudio.com/items?itemName=samverschueren.ava) - Snippets for [AVA](https://github.com/avajs/ava) ⭐ 20,827 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-17.

* [XO](https://marketplace.visualstudio.com/items?itemName=samverschueren.linter-xo) - Linter for [XO](https://github.com/xojs/xo) ⭐ 7,991 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-29.

* [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) - Opinionated code formatter for [Prettier](https://github.com/prettier/prettier-vscode) ⭐ 5,512 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-03.
...
> Linter for [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,316 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-01.
...
## [shell-format](https://github.com/foxundermoon/vs-shell-format) ⭐ 549 | 🐛 75 | 🌐 Shell | 📅 2026-08-26
...
* [Essence](https://github.com/essence-language/vscode-extension) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-20
...
* [Open in Code](https://github.com/sozercan/OpenInCode) ⭐ 914 | 🐛 2 | 🌐 Swift | 📅 2026-07-16 - macOS Finder toolbar app to open current folder in Visual Studio Code
